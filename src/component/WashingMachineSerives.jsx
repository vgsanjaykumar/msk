...
export default function WashingMachineService() {
    return (
        <section id="washing-machine" className="w-full py-16 bg-gradient-to-b from-purple-700 to-purple-900 dark:from-slate-900 dark:to-slate-800 text-white">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <p className="text-center text-gray-200 max-w-2xl mx-auto mb-12">
                    Quick, reliable and affordable washing machine repair, installation, drum issues, spinning problems, and servicing by expert technicians.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="bg-white/10 backdrop-blur-xl p-8 rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.05] transition text-center">
                        ...
                        <h3 className="text-xl font-semibold">Drum / Spin Issue</h3>
                        <p className="text-gray-300 mt-3 text-sm">
                            Fix vibration, noise, spin problems & jammed drums.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-xl p-8 rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.05] transition text-center">
                        ...
                        <p className="text-gray-300 mt-3 text-sm">
                            Leakage fixes, pipe replacements, and gasket servicing.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-xl p-8 rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.05] transition text-center">
                        <div className="flex justify-center text-cyan-300 mb-4"><FaTools size={40} /></div>
                        <h3 className="text-xl font-semibold">Machine Installation</h3>
                        <p className="text-gray-300 mt-3 text-sm">
                            Front-load, top-load installation by experts.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-xl p-8 rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.05] transition text-center">
                        ...
                        <p className="text-gray-300 mt-3 text-sm">
                            Full drum & filter cleaning for better performance.
                        </p>
                    </div>
